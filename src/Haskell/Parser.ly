...
> qvarid :: { HsQName }
>       : varid                 { UnQual $1 }
>       | QVARID                { Qual (ModName (fst $1)) (HsIdent (snd $1)) }
...
> qconid :: { HsQName }
>       : conid                 { UnQual $1 }
>       | QCONID                { Qual (ModName (fst $1)) (HsIdent (snd $1)) }
...
> qconsym :: { HsQName }
>       : consym                { UnQual $1 }
>       | QCONSYM               { Qual (ModName (fst $1)) (HsSymbol (snd $1)) }
...
> qvarsym1 :: { HsQName }
>       : QVARSYM               { Qual (ModName (fst $1)) (HsSymbol (snd $1)) }
