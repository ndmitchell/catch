...
loop
    ...
    where
        preFunc fn xs = conds(fn)[vs1/xs1 .. vs_n/xs_n]
        vs = ... -- free variables
\end{code}
...
\ignore\begin{code}
d :< (r :- cs) <=> (forall l `elem` lang r `o` defined d l => ctor d l `elem` cs)
\end{code}
