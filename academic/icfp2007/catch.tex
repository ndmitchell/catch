...
property :: FuncName -> Constraint -> Prop Req
replaceVars :: [Expr] -> Prop Req -> Prop Req
\end{code}
...
It is useful to have a way of expressing which values a constraint accepts. It turns out that the |(||>)| operator introduced earlier already provides all the necessary information:
