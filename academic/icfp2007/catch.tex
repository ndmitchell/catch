...
Although this technique is not complete, in practice it is sufficiently powerful. The algorithm combines specialisation with inlining, and only removes higher order functions.
