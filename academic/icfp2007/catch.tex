...
The function \C{property} takes a postcondition, and transforms it to constraints on the argument positions -- preconditions to the function. This operation can be seen as minimal precondition calculation. As in the precondition calculation in \S\ref{sec:precond}, each result becomes increasingly restrictive. As there are finitely many constraint/function pairs termination is guaranteed. Here again, a speed up can be obtained by tracking the dependencies between constraints.
